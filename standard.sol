 ...
 *
   ...
   removable max transaction and max wallet limits
   option to reduce taxes to 3% and 3%
 */
...
contract old is ERC20, Ownable {
    ...
    uint256 private reducedSellDevelopmentFee;
    ...
    constructor() ERC20("My Old Contract Standard", "OLD") {
        ...
        communityFee = 1;
        developerFee = 1;
        totalFees = marketingFee + developerFee + communityFee;
            ...
            if (
                ...
                if (restrictionsActive) {
                    require(
                        ...
                        "ERC20: Max transaction amount Exceeded"
                    );
                    require(
        ...
        if (takeFee) {
            ...
            if (automatedMarketMakerPairs[to] && taxEnabled) {
                if (reducedSellTax) {
                    ...
                    tokensForCommunityFund += (fees * communityFee) / totalFees;
                    tokensForMarketing += (fees * marketingFee) / totalFees;
                    tokensForDevelopment += (fees * developerFee) / totalFees;
                } else {
    ...
    function swapBack() private {
        ...
        (success, ) = address(developerWallet).call{value: ethForDevelopment}(
            ""
        );
